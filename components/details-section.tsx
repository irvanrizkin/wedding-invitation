import { MapPinIcon, ClockIcon, SparklesIcon } from "lucide-react";
import { GoogleMapsEmbed } from "@next/third-parties/google";

const details = [
  {
    icon: SparklesIcon,
    title: "Paseban Sena Ballroom",
    location: "Kota Probolinggo, Jawa Timur",
    address: "Jl. Suroyo No. 50-52",
    time: "Sesi 1 : 13.00 - 14.00 WIB",
  },
];
